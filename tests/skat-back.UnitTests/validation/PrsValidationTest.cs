...
public class PrsValidationTest
{
    ...
    public void Validate_CreatePrs_InvalidGameSum_ReturnsFailure()
    {
        ...
        result.Errors.Should().Contain(e =>
            e.ErrorMessage.Contains("The sum of won and lost games must be greater than 0 and less than 50."));
    }
    ...
    {
        // Arrange
        var prs = new UpdatePlayerRoundStatsDto(1, 20, 10, 6);
    ...
    {
        // Arrange
        var prs = new UpdatePlayerRoundStatsDto(-1, -1, -1, -1);
    ...
    {
        // Arrange
        var prs = new UpdatePlayerRoundStatsDto(1, 20000, 10, 6); // Points exceed limit
    ...
    {
        // Arrange
        var prs = new UpdatePlayerRoundStatsDto(1, 20, 40, 20); // Lost + Won = 50
    ...
    {
        // Arrange
        var prs = new UpdatePlayerRoundStatsDto(0, 20, 10, 6); // PlayerId is empty
    ...
    {
        // Arrange
        var prs = new UpdatePlayerRoundStatsDto(1, 0, 10, 6); // Points are zero
    ...
    {
        // Arrange
        var prs = new UpdatePlayerRoundStatsDto(1, 20, 0, 0); // Lost + Won = 0
    ...
    [InlineData(1, 20, 30, 0)] // Lost + Won = 50
    [InlineData(0, 20, 10, 6)] // Empty PlayerId
    public void Validate_UpdatePrs_VariousCases_ReturnsExpectedResults(int playerId, int points,
        int won, int lost)
    {
        // Arrange
        var prs = new UpdatePlayerRoundStatsDto(playerId, points, won, lost);
